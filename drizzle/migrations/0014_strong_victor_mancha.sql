CREATE TYPE "public"."predictions__period_type_type" AS ENUM('REG', 'OT', 'SO');--> statement-breakpoint
CREATE TABLE "predictions__predictions" (
	...
	"predicted_period_type" "predictions__period_type_type" NOT NULL,
	"actual_home_score" integer,
	"actual_away_score" integer,
	"actual_period_type" "predictions__period_type_type",
