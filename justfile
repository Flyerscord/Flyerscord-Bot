...
web:
    docker compose -f docker-compose.yml -p flyerscord-discord-prod up --pull always --force-recreate -d web

web-full:
    docker compose -f docker-compose.yml -p flyerscord-discord-prod up --pull always --force-recreate -d bot migrate web
...
dev-web:
    docker compose -f docker-compose-dev.yml -p flyerscord-discord-dev up --build --force-recreate -d web
