...
import type { userManagementConfigSchema } from "./userManagement/UserManagementModule";
...
export const ModuleMap: Record<Modules, Module> = {
  ...
  UserManagement: UserManagementModule.getInstance(),
...
export type ModuleConfigMap = {
  ...
  UserManagement: ConfigFromSchemas<typeof userManagementConfigSchema>;
