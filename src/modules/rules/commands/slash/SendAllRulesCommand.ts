...
export default class SendAllRulesCommand extends AdminSlashCommand {
  constructor() {
    super("rulessendall", "Sends all of the rules to the channel");
  }

  async execute(Interaction: ChatInputCommandInteraction): Promise<void> {
    const replies = await discord.interactions.createReplies(Interaction, "rules:SendAllRulesCommand:execute", true);
    ...
    await replies.reply("Sent all rules to the channel!");
  }
}
