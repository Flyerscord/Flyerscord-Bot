...
export function getDivisionalStandingsEmbed(
...
export function getConferenceStandingsEmbed(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  data: any,
  conference: number,
): EmbedBuilder {
...
export function getWildcardStandingsDivLeaderEmbed(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  data: any,
  conference: number,
  div: number,
...
export function getWildcardStandingsEmbed(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  data: any,
  conference: number,
): EmbedBuilder {
...
export function getScheduleEmbed(
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  data: any,
  gamesToPrint: number,
): EmbedBuilder {
